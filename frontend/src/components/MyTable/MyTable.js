        ...
        <div className="flex items-center gap-2">
            ...
            {onDelete && (
                <button
                    ...
                    className="inline-flex items-center gap-1 rounded-xl px-3 py-1.5 text-sm font-medium bg-red-600 hover:bg-red-700 text-white transition"
                >
                    <svg xmlns="http://www.w3.org/2000/svg" className="" width='22' height='22' viewBox="0 0 24 24" fill="none"
