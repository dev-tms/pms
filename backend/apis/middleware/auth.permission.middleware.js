...
const secret = require('../configs/envconfig')['jwt_secret'];
const ADMIN_PERMISSION = require('../configs/envconfig')['permissionLevels']['ADMIN'];
...
export function onlyAdminCanDoThisAction(req, res, next) {
    let user_permission_level = parseInt(req.jwt.permissionLevel);
